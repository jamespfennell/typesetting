...
func TestExpand_BasicCase(t *testing.T) {
	...
	Register(&ctx.Registry, "funca", func() stream.TokenStream {
		return testutil.NewStream("a1", "a2")
	})

	inputStream := testutil.NewStream("01", "funca", "02")
	expectedStream := testutil.NewStream("01", "a1", "a2", "02")
...
func TestExpand_InputProcessing(t *testing.T) {
	...
	Register(&ctx.Registry, "funca", func(c *context.Context, s stream.TokenStream) stream.TokenStream {
		t, _ := s.NextToken()
		return testutil.NewStream("a1", t.Value(), "a2")
	})

	inputStream := testutil.NewStream("01", "funca", "02")
	expectedStream := testutil.NewStream("01", "a1", "02", "a2")
	actualStream := Expand(ctx, inputStream)
...
func TestExpand_StackIsConsumed(t *testing.T) {
	ctx := context.NewContext()
	Register(&ctx.Registry, "funca", func() stream.TokenStream {
		return testutil.NewStream("funcb", "a1")
	})
	Register(&ctx.Registry, "funcb", func(c *context.Context, s stream.TokenStream) stream.TokenStream {
		_, _ = s.NextToken()
		_, _ = s.NextToken()
		return testutil.NewStream("b1", "b2")
	})

	startingStream := testutil.NewStream("01", "funca", "02", "03")
	expectedStream := testutil.NewStream("01", "b1", "b2", "03")
...
func TestExpand_InputToExpansionFunctionNotExpanded(t *testing.T) {
	...
	startingStream := testutil.NewStream("01", "funca", "funcb")
	expectedStream := testutil.NewStream("01", "a1", "a2")
	actualStream := Expand(ctx, startingStream)
...
func TestExpand_NonExpandableCommandsPassThrough(t *testing.T) {
	...
	startingStream := testutil.NewStream("funca")
	expectedStream := testutil.NewStream("funca")
	actualStream := Expand(ctx, startingStream)
