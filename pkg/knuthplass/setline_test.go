...
func TestSetLine_ErrorCases(t *testing.T) {
	paramsList := []struct {
		...
		{
			"No stretchability to meet the line length",
			[]primitives.Item{
		...
		{
			"No shrinkability to meet the line length",
			[]primitives.Item{
				primitives.NewBox(20),
				primitives.NewGlue(20, 0, 10),
				primitives.NewBox(20),
			},
			50,
			[]FixedItem{
...
func TestSetLine_NoErrorCases(t *testing.T) {
	paramsList := []struct {
		...
		},
		{
			...
			[]primitives.Item{
				primitives.NewBox(20),
				primitives.NewInfStretchGlue(20, 10),
				primitives.NewBox(20),
				primitives.NewInfStretchGlue(20, 10),
				primitives.NewBox(20),
			},
		...
		},
		{
			...
			[]primitives.Item{
				...
				primitives.NewInfStretchGlue(20, 10),
				primitives.NewBox(20),
				primitives.NewGlue(20, 10, 1000000),
				primitives.NewBox(20),
			},
			120,
			[]FixedItem{
		...
		{
			"Infinite stretch glue doesn't affect shrinkability",
			[]primitives.Item{
				primitives.NewBox(20),
				primitives.NewInfStretchGlue(20, 10),
				primitives.NewBox(20),
